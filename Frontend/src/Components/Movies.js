...
import { FaRandom, FaComments } from "react-icons/fa";
import './Movies.css';
...
const Movies = () => {
  ...
  // 🔹 Filter only movies
  const topMovies = dataa.filter(movie => movie.moviemeta === "movie");
    ...
    <>
      ...
      <div className="movies-container">
        {filteredMovies.length === 0 ? (
          <p>No movies found...</p> // 🔹 Display message if no results
        ) : (
